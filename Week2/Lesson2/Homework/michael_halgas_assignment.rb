...
#returns JSON from Mashable containing all stories
...
new_stories.each do |new_news|
	puts "Title: #{new_news['title']}"
	puts "Author: #{new_news['author']}"
	puts "Content: #{new_news['content']['plain']}"
	puts "---------------------------------------\n\n"
end